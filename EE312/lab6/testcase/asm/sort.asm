00010148 <main>:
   ...
   10190:	01d00793          	li	a5,29 <- error?
   10194:	fce7d6e3          	bge	a4,a5,10160 <main+0x18>
...
000101c0 <sort>:
   ...
   101f4:	fec42783          	lw	a5,-20(s0)     <------jumped
   101f8:	00279793          	slli	a5,a5,0x2
   101fc:	fdc42703          	lw	a4,-36(s0)
   10200:	00f707b3          	add	a5,a4,a5
   10204:	0007a703          	lw	a4,0(a5) //0x09
   10208:	fe442783          	lw	a5,-28(s0)
   1020c:	00279793          	slli	a5,a5,0x2
   10210:	fdc42683          	lw	a3,-36(s0)
   10214:	00f687b3          	add	a5,a3,a5
   10218:	0007a783          	lw	a5,0(a5)     //0x18
   1021c:	00e7d663          	bge	a4,a5,10228 <sort+0x68> <--------- do not jump
   10220:	fe442783          	lw	a5,-28(s0)
   10224:	fef42623          	sw	a5,-20(s0)
   10228:	fe442783          	lw	a5,-28(s0)
   1022c:	00178793          	addi	a5,a5,1   //0x1e
   10230:	fef42223          	sw	a5,-28(s0)
   10234:	fe442703          	lw	a4,-28(s0)  //0x1e
   10238:	fd842783          	lw	a5,-40(s0)  //0x1e
   1023c:	faf74ce3          	blt	a4,a5,101f4 <sort+0x34> //0   <-------- jump
   10240:	fe842783          	lw	a5,-24(s0)
   10244:	00279793          	slli	a5,a5,0x2  //0x20
   10248:	fdc42703          	lw	a4,-36(s0)
   1024c:	00f707b3          	add	a5,a4,a5
   10250:	0007a783          	lw	a5,0(a5)  //0x16
   10254:	fef42023          	sw	a5,-32(s0)
   10258:	fe842783          	lw	a5,-24(s0)  //0x8
   1025c:	00279793          	slli	a5,a5,0x2 //0x20
   10260:	fdc42703          	lw	a4,-36(s0)
   10264:	00f707b3          	add	a5,a4,a5
   10268:	fec42703          	lw	a4,-20(s0) //0x15
   1026c:	00271713          	slli	a4,a4,0x2 //0x54
   10270:	fdc42683          	lw	a3,-36(s0)
   10274:	00e68733          	add	a4,a3,a4
   10278:	00072703          	lw	a4,0(a4)  //0x09
   1027c:	00e7a023          	sw	a4,0(a5)
   10280:	fec42783          	lw	a5,-20(s0) //0x15
   10284:	00279793          	slli	a5,a5,0x2 //0x54
   10288:	fdc42703          	lw	a4,-36(s0)
   1028c:	00f707b3          	add	a5,a4,a5
   10290:	fe042703          	lw	a4,-32(s0) //0x16
   10294:	00e7a023          	sw	a4,0(a5)
   10298:	fe842783          	lw	a5,-24(s0) //0x8
   1029c:	00178793          	addi	a5,a5,1 //0x9
   102a0:	fef42423          	sw	a5,-24(s0)
   102a4:	fe842703          	lw	a4,-24(s0) //0x9
   102a8:	fd842783          	lw	a5,-40(s0) //0x1e
